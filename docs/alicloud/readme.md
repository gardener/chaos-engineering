...
This module provides [`chaostoolkit`](https://chaostoolkit.org) actions to simulate zone outages in Alicloud. It supports:
...
- `ali_access_key`: Access key id
- `ali_secret_key`: Secret access key


## Examples

- [Assess Filters Impact](/docs/alicoud/assess-filters-impact.json)
- [Run Compute Failure Simulation](/docs/alicloud/run-compute-failure-simulation.json)
- [Run Network Failure Simulation](/docs/alicloud/run-network-failure-simulation.json)
